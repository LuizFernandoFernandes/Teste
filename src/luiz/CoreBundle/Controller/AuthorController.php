...
use luiz\ModelBundle\Entity\Author;
use luiz\ModelBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('luizModelBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("luizCoreBundle:Author:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('luizModelBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("luizModelBundle:Author:edit.html.twig")
     */
